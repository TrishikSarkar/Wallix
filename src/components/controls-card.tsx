...
export function ControlsCard() {
  ...
  return (
    <motion.div
      ...
      className="flex w-[320px] flex-col gap-2.5 rounded-[24px] border border-[#eaeaea] bg-white p-4 shadow-[0_1px_3px_0_rgba(0,0,0,0.04),0_1px_2px_-1px_rgba(0,0,0,0.06)]"
    >
      <StyleSelector />
